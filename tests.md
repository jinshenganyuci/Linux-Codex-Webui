...
| [Chat Composer and Message Rendering](tests/chat-composer-rendering/index.md) | 40 | Composer controls, queued messages, plan mode, markdown parsing, file links, attachments, generated images, and visible message rows. |

...
describe('feedback diagnostics', () => {
  ...
  it('builds a mailto with context and recent diagnostics', () => {
    ...
    expect(mailto).toContain('subject=Linux-Codex-Webui%20feedback%3A%20Request%20failed%20with%20HTTP%20500')
  ...
  it('uses a single-line subject for multiline diagnostics', () => {
    ...
    expect(subject).toBe('Linux-Codex-Webui feedback: Top level failure')
  })

          ...
          <div v-if="isAttachMenuOpen" :id="attachMenuId" ref="attachMenuRef" class="thread-composer-attach-menu" :style="attachMenuStyle" role="dialog" aria-label="添加与输入设置">
            ...
            >
              <span class="thread-composer-attach-setting-copy">
                ...
                <span class="thread-composer-attach-setting-description">{{ t(activeThreadId && activeThreadId !== '__new-thread__' ? 'Only this chat; preserved after reload.' : 'For this new chat only.') }}</span>
              </span>
              <span
